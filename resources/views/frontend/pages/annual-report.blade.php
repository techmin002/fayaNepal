...
<script>
    < link rel = "stylesheet"
    href = "path/to/fontawesome/css/all.min.css" >
        <
        link rel = "stylesheet"
            ...
            <figure class="shape-box shape-box_half">
                ...
                <figcaption>
                    ...
                    <div class="btn-class-name">
                        <a type="button" href="{{ asset('upload/images/reports/' . $report->file) }}"
                            class="btn btn-primary btn-class-name-btn" download><i class="fa-solid fa-download"></i>
                            Download</a>
                    </div>
                </figcaption>
