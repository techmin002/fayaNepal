        ...
        <div class="row">
            <div class="col-lg-9 sm-padding">
                <div class="blog-items single-post row">
                    <img src="{{ asset('upload/images/events/'.$data['blog']->image)}}" alt="blog post">
                ...
                <div class="sidebar-wrap">
                    ...
                    <div class="sidebar-widget mb-50">
                        ...
                        <ul class="recent-posts">
                            ...
                            <li>
                                <img src="{{ asset('upload/images/events/'.$item->image)}}" alt="blog post">
                                <div>
                                    <h4><a href="{{ route('event.detail',$item->id) }}">{{ $item->title }}</a></h4>
