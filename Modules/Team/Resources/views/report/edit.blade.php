    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('reports.update', $report->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control"
                                                    placeholder="Enter Title" value="{{ $report->title }}" required>
                                                @error('title')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="report_type" class="form-control" id="">
                                                    <option value="annual" {{ old('report_type', $report->report_type ?? '') == 'current' ? 'selected' : '' }}>Annual Reports</option>
                                                    <option value="project" {{ old('report_type', $report->report_type ?? '') == 'current' ? 'selected' : '' }}>Project Reports</option>
                                                </select>
                                                @error('name')
                                                <p style="color: red">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="summernote" placeholder="Enter Description">{{ $report->description }}</textarea>
                                                @error('description')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('upload/images/reports/'.$report->image) }}" alt="{{ $report->title }}" width="200px">
                                                @error('image')
                                                        <p style="color: red">{{ $message }}</p>
                                                    @enderror
