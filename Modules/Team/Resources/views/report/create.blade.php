...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <form id="product-form" action="{{ route('reports.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="image">Image (447.983×430)</label>
                                                <p class="text-muted small mb-2">
                                                    <strong>Required size:</strong> Exactly 447.983×430 pixels<br>
                                                ...
                                                <input type="file" id="file-ip-1" accept="image/*"
                                                       ...
                                                       onchange="showPreview448(event); validateImage448(this);" name="image">
                                                ...
                                                <div class="preview mt-3 text-center">
                                                    ...
                                                    <div id="size-error-448" class="text-danger small mt-2" style="display: none;"></div>
                                                    <div id="dimension-display-448" class="text-muted small mt-1" style="display: none;"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <script>
                                    ...
                                    function validateImage448(input) {
                                        const sizeError = document.getElementById('size-error-448');
                                        const dimensionDisplay = document.getElementById('dimension-display-448');
                                            ...
                                            reader.onload = function (e) {
                                                ...
                                                img.onload = function () {
                                                    ...
                                                    if (Math.abs(this.width - targetWidth) > widthTolerance ||
                                                        ...
                                                        sizeError.innerHTML = `⚠️ Image must be exactly <strong>447.983×430</strong> pixels.<br>Your image is <strong>${this.width}×${this.height}</strong>.`;
