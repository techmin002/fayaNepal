...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <form id="product-form" action="{{ route('executives.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" name="position" class="form-control" placeholder="Enter Position" value="{{old('position')}}" required>
                                        @error('position')
                                        <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
