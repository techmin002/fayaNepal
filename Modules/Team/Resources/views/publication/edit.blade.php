...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('publications.index') }}">Publication</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('publications.update', $publication->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control"
                                                    placeholder="Enter Title" value="{{ $publication->title }}" required>
                                                @error('title')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="summernote" placeholder="Enter Description">{{ $publication->description }}</textarea>
                                                @error('description')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('upload/images/publications/'.$publication->image) }}" alt="{{ $publication->title }}" width="200px">
                                                @error('image')
                                                        <p style="color: red">{{ $message }}</p>
                                                    @enderror
