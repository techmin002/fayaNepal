    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('events.update',$event->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="shortdescription" class="summernote" id="" cols="30" rows="3">{{ $event->shortdescription }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="summernote" id="" cols="30" rows="3">{{ $event->description }}</textarea>
                                                @error('description')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date" class="form-control"
                                                    placeholder="Enter Contact " value="{{ $event->date }}">
                                                @error('date')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="file-ip-1" accept="image/*"
                                                    ...
                                                    <img src="{{ asset('upload/images/events/'.$event->image) }}" alt="{{ $event->title }}" width="200px">
                                                @error('image')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
